...
1. Create an account on the workshop RStudio Connect server by visiting ({{< var rsconnect_url >}}) and clicking the **login** link in the upper right corner.
...
1. Join the RStudio Cloud Workspace dedicated to this workshop by visiting this URL: ({{< var rstudio_cloud_workspace_url >}}). If you already have an RStudio Cloud account, you are welcome to use it for the workshop. Otherwise, you can create a new account for free.
