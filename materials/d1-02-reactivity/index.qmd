...
![](assets/img/joe_shinydevcon.png)
...
[Code-Along 1](codealong-1.html){target="_blank"}: Building the MET image viewer foundations
...
* `debounce/throttle`: Limit rate of reactive changes
