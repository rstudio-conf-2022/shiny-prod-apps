...
## The R Process in Shiny {background-image="assets/img/samus_managing.png" background-size="80%"}

## Powerup with Delegation {background-image="assets/img/samus_powerup.jpg" background-size="80%"}
